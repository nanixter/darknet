...
void update_convolutional_layer_gpu(convolutional_layer layer, update_args a, cudaStream_t *stream);
...
void resize_convolutional_layer(convolutional_layer *layer, int w, int h, cudaStream_t *stream);
